...
#SBATCH --job-name=epem-dnA-fullReco
#SBATCH --output=larmatchme_larflowreco_epem_darknuA_sub0.log
...
#SBATCH --error=griderr_larmatcheme_larflowreco_epem_darknuA_sub0.%j.%N.err
...
SAMPLE_NAME="epem_DarkNu_BenchmarkA"
INPUTSTEM=merged_dlreco
FILEIDLIST=/cluster/tufts/wongjiradlabnu/nutufts/dlgen2prod/larmatch_and_reco_scripts/larmatch_runlist_epem_DarkNu_BenchmarkA.txt
