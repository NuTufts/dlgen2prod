...
#SBATCH --job-name=bnbnu500k_lantern
#SBATCH --output=stdout_mcc9_v40a_dl_run3b_bnb_nu_overlay_500k_CV_sub00.log
...
SAMPLE_NAME=mcc9_v40_bnb_nu_overlay_500k_CV_run3b
INPUTSTEM=merged_dlreco
FILEIDLIST=/cluster/tufts/wongjiradlabnu/twongj01/gen2/dlgen2prod/larmatch_and_reco_scripts/larmatch_runlist_mcc9_v40a_dl_run3b_bnb_nu_overlay_500k_CV.txt
