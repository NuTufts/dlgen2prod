...
#SBATCH --job-name=bnbnu-fullReco
#SBATCH --output=larmatchme_larflowreco_mcc9_run3_bnbnu_sub2.log
...
#SBATCH --error=griderr_larmatcheme_larflowreco_mcc9_run3_bnbnu_sub2.%j.%N.err
...
FILEIDLIST=/cluster/tufts/wongjiradlabnu/nutufts/dlgen2prod/larmatch_and_reco_scripts/larmatch_runlist_mcc9_v29e_dl_run3b_bnb_nu_overlay_nocrtremerge.txt
