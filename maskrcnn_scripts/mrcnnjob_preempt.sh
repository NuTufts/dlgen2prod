...
FILELIST=/cluster/tufts/wongjiradlab/larbys/data/mcc9/mcc9_v29e_dl_run3b_bnb_intrinsic_nue_LowE/goodlist.txt
SUBMITNUM=0
...
# for VARIABLE in {0..17} #need ext to go from 0 to 57
for VARIABLE in {10..10}

do
  # echo $VARIABLE
  let line=(58 * $ARRAYID + 1 + $VARIABLE)
