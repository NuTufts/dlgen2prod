...
#inputlist=DLPRODDIR+"/run1inputlists/mcc9_v28_wctagger_bnb5e19_filelist.txt"
#stem="merged_dlreco"
...
reco_outfolder="/cluster/tufts/wongjiradlab/nutufts/data/v1/%s/larflowreco/ana/"%(samplename)
